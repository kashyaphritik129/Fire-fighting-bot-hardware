...
int val;
int Speeed = 255;
int servo_position = 0 ;  // Always starting Servo From Zero
  
void setup()
{
  HC05.begin(9600); //Baudrate 9600 , Choose your own baudrate 
  pinMode(13, OUTPUT); // Defining Pump Pin-8
  name_servo.attach (9); // Defining Servomotor Pin-9 
  
}
void loop(){
  if(HC05.available() > 0){//When HC05 receive something{
